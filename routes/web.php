...
Route::get('test',function (){
        ...
        Cookie::forever('cookie_policy', 'yes');

        dd(Cookie::get('cookie_policy'));
});
...
Route::group(['namespace' => 'Backend', 'prefix' => 'admin', 'middleware' => config('menu.middleware')], function () {
    ...
    Route::post('add-custom-menu', 'MenuController@addcustommenu')->name('haddcustommenu.hd');
    Route::post('delete-item-menu', 'MenuController@deleteitemmenu')->name('hdeleteitemmenu.hd');
    Route::post('delete-menug', 'MenuController@deletemenug')->name('hdeletemenug.hd');
    Route::post('create-new-menu', 'MenuController@createnewmenu')->name('hcreatenewmenu.hd');
    Route::post('generate-menu-control', 'MenuController@generatemenucontrol')->name('hgeneratemenucontrol.hd');
    Route::post('update-item', 'MenuController@updateitem')->name('hupdateitem.hd');
    Route::post('save-custom-menu', 'MenuController@saveCustomMenu')->name('hcustomitem.hd');
    Route::post('change-location', 'MenuController@updateLocation')->name('update-location.hd');
});
...
// subscription routes for app
Route::group(['prefix' => 'subscriptions/app'], function(){
    // Route::get('plans', 'SubscriptionController@plans')->name('subscription.plans');
    Route::get('/{plan}/{name}', 'SubscriptionController@showFormApp')->name('subscriptions.form.app');
    Route::post('subscribe/{plan}', 'SubscriptionController@subscribeApp')->name('subscriptions.subscribe.app');
    Route::post('update/{plan}', 'SubscriptionController@updateSubscriptionApp')->name('subscriptions.update.app');
    Route::get('status_fail','SubscriptionController@statusFailApp')->name('subscriptions.status.fail.app');
    Route::get('status_success','SubscriptionController@statusSuccessApp')->name('subscriptions.status.success.app');
    // Route::post('subscribe','SubscriptionController@courseSubscribed')->name('subscription.course_subscribe');
});
...
Route::get('/terms-of-use-eula', function (){
