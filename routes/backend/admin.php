...
Route::group(['middleware' => 'role:teacher|owner|administrator'], function () {
    Route::resource('orders', 'Admin\OrderController');
});
Route::group(['middleware' => 'role:administrator|owner'], function () {// verfivar mais tarde lista de permissoes, erro orders table
    ...
    //===== Settings Routes =====//
    Route::get('settings/general', ['uses' => 'Admin\ConfigController@getGeneralSettings', 'as' => 'general-settings-get']);

    Route::post('settings/general', ['uses' => 'Admin\ConfigController@saveGeneralSettings'])->name('general-settings');

    Route::get('settings/social', ['uses' => 'Admin\ConfigController@getSocialSettings'])->name('social-settings-get');
    ...
    Route::get('settings/zoom', ['uses' => 'Admin\ConfigController@getZoomSettings'])->name('zoom-settings-get');
    ...
    Route::get('sponsors/status/{id}', 'Admin\SponsorController@status')->name('sponsors.status.get', 'id');
    ...
    Route::get('testimonials/status/{id}', 'Admin\TestimonialController@status')->name('testimonials.status.get', 'id');
    ...
    Route::get('faqs/status/{id}', 'Admin\FaqController@status')->name('faqs.status.get');
    ...
    Route::get('tax/status/{id}', 'TaxController@status')->name('tax.status.get', 'id');
    Route::post('tax/status', 'TaxController@updateStatus')->name('tax.status');


    //====== Coupon Routes =====//
    Route::resource('coupons', 'CouponController');
    Route::get('coupons/status/{id}', 'CouponController@status')->name('coupons.status.get', 'id');
...
Route::resource('workouts', 'Admin\CoursesController');
Route::get('get-courses-data', ['uses' => 'Admin\CoursesController@getData', 'as' => 'workouts.get_data']);
Route::post('courses_mass_destroy', ['uses' => 'Admin\CoursesController@massDestroy', 'as' => 'workouts.mass_destroy']);
Route::post('courses_restore/{id}', ['uses' => 'Admin\CoursesController@restore', 'as' => 'workouts.restore']);
Route::delete('courses_perma_del/{id}', ['uses' => 'Admin\CoursesController@perma_del', 'as' => 'workouts.perma_del']);
Route::post('course-save-sequence', ['uses' => 'Admin\CoursesController@saveSequence', 'as' => 'workouts.saveSequence']);
Route::get('course-publish/{id}', ['uses' => 'Admin\CoursesController@publish', 'as' => 'workouts.publish']);
...
Route::group(['prefix' => 'blog'], function () {
    ...
    Route::get('edit/{id}', 'Admin\BlogController@edit')->name('blogs.edit.get');
