...
class LessonsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $courses = $courses = Course::has('category')->pluck('title', 'id')->prepend('Please select', '');//->ofTeacher()
    ...
    public function getData(Request $request)
    {
        ...
        $has_edit = false;
        $lessons = "";
        $lessons = Lesson::query()->where('live_lesson', '=', 0)->whereIn('course_id', Course::pluck('id'));//ofTeacher()->
    ...
    public function create()
    {
        ...
        $courses = Course::has('category')->get()->pluck('title', 'id')->prepend('Please select', '');//->ofTeacher()
