...
//     }
    ...
    {
        $data = [
            'font_color', 'contact_data', 'counter', 'total_students', 'total_courses', 'total_teachers', 
            'logo_b_image', 'logo_w_image', 'logo_white_image', 'contact_data', 'footer_data', 'app.locale', 
            'app.display_type', 'app.currency', 'app.name', 'app.url', 'access.captcha.registration', 
            'paypal.active', 'payment_offline_active'
        ];
    ...
    public function getCategories(Request $request)
    {
        ...
        return response()->json(['status' => 'success', 'result' => ["data" => $categories]]);
    }
