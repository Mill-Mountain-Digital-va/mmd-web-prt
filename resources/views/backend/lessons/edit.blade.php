        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12 form-group">
                    {!! Form::label('equipment', trans('labels.backend.lessons.fields.equipment'), ['class' => 'control-label']) !!}
                    {!! Form::textarea('equipment', old('equipment'), ['class' => 'form-control ', 'placeholder' => trans('labels.backend.lessons.short_description_placeholder')]) !!}
                </div>
            </div>
            
            <div class="row">
                <div class="col-12 col-lg-6 form-group">
                    {!! Form::label('duration', trans('labels.backend.lessons.fields.duration').'*', ['class' => 'control-label']) !!}
                    {!! Form::number('duration', old('duration'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.lessons.fields.duration'), 'required' => '']) !!}
                </div>
                <div class="col-12 col-lg-6 form-group">
                    {!! Form::label('repetitions', trans('labels.backend.lessons.fields.repetitions').'*', ['class' => 'control-label']) !!}
                    {!! Form::number('repetitions', old('repetitions'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.lessons.fields.repetitions'), 'required' => '']) !!}
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-lg-6 form-group">
                    {!! Form::label('break_duration', trans('labels.backend.lessons.fields.break_duration').'*', ['class' => 'control-label']) !!}
                    {!! Form::number('break_duration', old('break_duration'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.lessons.fields.break_duration'), 'required' => '']) !!}
                </div>
            </div>
            <div class="row">
                <div class="col-12 form-group">
