...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body" id="newsletter">
            <h5>@lang('labels.backend.general_settings.mail_configuration_note',['link'=>'<a target="_blank" href="'.route('admin.general-settings-get',['tab'=>'email']).'">'])</h5>
        ...
        <div class="card-footer clearfix">
            <div class="row">
                <div class="col">
                    {{ form_cancel(route('admin.general-settings-get'), __('buttons.general.cancel')) }}
                </div><!--col-->
